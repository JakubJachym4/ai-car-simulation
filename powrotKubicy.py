...
class Car:
    ...
    def draw(self, screen):
        ...
        self.draw_radar(screen)  # OPTIONALLY FOR SENSORS
...
def run_simulation():
    ...
    # Create Random Cars (No Neural Network)
    for _ in range(10):  # Example: Create 10 cars
        cars.append(Car())
    ...
    while True:
        ...
        for car in cars:
            if car.is_alive():
                ...
                # Simple Random Movement (Instead of Neural Network)
                random_action = random.choice(["left", "right", "slow", "speed_up"])
                if random_action == "left":
                    car.angle += 10
                elif random_action == "right":
                    car.angle -= 10
                elif random_action == "slow":
                    if car.speed - 2 >= 12:
                        car.speed -= 2
                else:
                    car.speed += 2

        if still_alive == 0 or counter == 30 * 40:  # Stop after 20 seconds or if no cars are alive
            break
